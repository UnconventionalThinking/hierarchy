...
public class AppSymbols_SchemaName { 
	...
	public static MatrixName annotationdetectiontests$_CC_$WEB$__$FORM;
	public static MatrixName annotationdetectiontests$_CC_$Test$__$Matrix;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  annotationdetectiontests::`WEB`.`FORM`

		annotationdetectiontests$_CC_$WEB$__$FORM = multiLevelSymbol_Factory.createNew_SchemaName(AppSymbols_DescTagName.annotationdetectiontests, AppSymbols_DescTagName.WEB$__$FORM,creation_Has_StaticVersion);

		//  annotationdetectiontests::`Test`.`Matrix`

		annotationdetectiontests$_CC_$Test$__$Matrix = multiLevelSymbol_Factory.createNew_SchemaName(AppSymbols_DescTagName.annotationdetectiontests, AppSymbols_DescTagName.Test$__$Matrix,creation_Has_StaticVersion);
