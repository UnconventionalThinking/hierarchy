...
public class AppSymbols_DescTag { 
	...
	public static DescriptorTag annotationdetectiontests$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED;
	public static DescriptorTag annotationdetectiontests$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECTOR;
	public static DescriptorTag annotationdetectiontests$_CC_$WEB$__$FORM$_CC_$OPTION;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  annotationdetectiontests::`WEB`.`FORM`::`FORM`.`REQUIRED`

		annotationdetectiontests$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.annotationdetectiontests$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$REQUIRED,creation_Has_StaticVersion);

		//  annotationdetectiontests::`WEB`.`FORM`::`FORM`.`SELECTOR`

		annotationdetectiontests$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECTOR = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.annotationdetectiontests$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$SELECTOR,creation_Has_StaticVersion);

		//  annotationdetectiontests::`WEB`.`FORM`::OPTION

		annotationdetectiontests$_CC_$WEB$__$FORM$_CC_$OPTION = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.annotationdetectiontests$_CC_$WEB$__$FORM, AppSymbols_DescTagName.OPTION,creation_Has_StaticVersion);
