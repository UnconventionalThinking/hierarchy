...
public class AppSymbols_MatrixName { 
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		annotationdetectiontests$_CC_$Test$__$Matrix = multiLevelSymbol_Factory.createNew_MatrixName(AppSymbols_DescTagName.annotationdetectiontests, AppSymbols_DescTagName.Test$__$Matrix,creation_Has_StaticVersion);
