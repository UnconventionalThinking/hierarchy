...
public class AppSymbols_Label { 
	...
	public static final int SELECT$_ID_$ = 156;
	public static Label OPTION;
	public static final int OPTION$_ID_$ = 163;
	public static Label MY$95$DESC;
	public static final int MY$95$DESC$_ID_$ = 179;
	public static Label NUM1;
	public static final int NUM1$_ID_$ = 180;
	public static Label NUM2;
	public static final int NUM2$_ID_$ = 191;
	...
	public static final int FORM$__$REQUIRED$_ID_$ = 145;
	public static Label FORM$__$SELECT;
	public static final int FORM$__$SELECT$_ID_$ = 157;
	public static Label TEST$__$SCHEMA;
	public static final int TEST$__$SCHEMA$_ID_$ = 174;
	public static Label MY$95$DESC$__$NUM1;
	public static final int MY$95$DESC$__$NUM1$_ID_$ = 182;
	public static Label MY$95$DESC$__$NUM2;
	public static final int MY$95$DESC$__$NUM2$_ID_$ = 192;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed,
		...
		SELECT = (have_ParentAppControl) ? singleSymbol_Factory.createNew_Label("SELECT", true) :
				singleSymbol_Factory.createNew_Label("SELECT", 156, true, null);
		...
		MY$95$DESC = (have_ParentAppControl) ? singleSymbol_Factory.createNew_Label("MY_DESC", true) :
				singleSymbol_Factory.createNew_Label("MY_DESC", 179, true, null);
		NUM1 = (have_ParentAppControl) ? singleSymbol_Factory.createNew_Label("NUM1", true) :
				singleSymbol_Factory.createNew_Label("NUM1", 180, true, null);
		NUM2 = (have_ParentAppControl) ? singleSymbol_Factory.createNew_Label("NUM2", true) :
				singleSymbol_Factory.createNew_Label("NUM2", 191, true, null);
		...
		FORM$__$REQUIRED = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 145, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
		...
		FORM$__$SELECT = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 157, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
		...
		TEST$__$SCHEMA = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 174, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
		...
		MY$95$DESC$__$NUM1 = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 182, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
		...
		MY$95$DESC$__$NUM2 = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 192, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
