...
public class AppSymbols_SchemaName { 
	...
	public static MatrixName net$__$unconventionalthinking$__$matrix$__$schema$_CC_$TEST$__$SCHEMA;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  `net`.`unconventionalthinking`.`matrix`.`schema`::`TEST`.`SCHEMA`

		net$__$unconventionalthinking$__$matrix$__$schema$_CC_$TEST$__$SCHEMA = multiLevelSymbol_Factory.createNew_SchemaName(AppSymbols_DescTagName.net$__$unconventionalthinking$__$matrix$__$schema, AppSymbols_DescTagName.TEST$__$SCHEMA,creation_Has_StaticVersion);
