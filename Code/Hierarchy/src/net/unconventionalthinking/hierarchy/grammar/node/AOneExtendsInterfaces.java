...
public final class AOneExtendsInterfaces extends PExtendsInterfaces
{
    ...
    public Object clone()
    {
        return new AOneExtendsInterfaces(
    ...
    {
        ((Analysis) sw).caseAOneExtendsInterfaces(this);
    }
