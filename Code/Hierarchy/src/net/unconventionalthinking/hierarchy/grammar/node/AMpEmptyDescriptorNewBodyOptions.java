...
public final class AMpEmptyDescriptorNewBodyOptions extends PDescriptorNewBodyOptions
{
    private TLBrc _lBrc_;
    private TRBrc _rBrc_;

    public AMpEmptyDescriptorNewBodyOptions()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpEmptyDescriptorNewBodyOptions(
    ...
    {
        ((Analysis) sw).caseAMpEmptyDescriptorNewBodyOptions(this);
    }
