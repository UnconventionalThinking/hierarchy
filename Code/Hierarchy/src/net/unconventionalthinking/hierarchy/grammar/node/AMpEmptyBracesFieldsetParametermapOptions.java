...
public final class AMpEmptyBracesFieldsetParametermapOptions extends PFieldsetParametermapOptions
{
    private TLBrc _lBrc_;
    private TRBrc _rBrc_;

    public AMpEmptyBracesFieldsetParametermapOptions()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpEmptyBracesFieldsetParametermapOptions(
    ...
    {
        ((Analysis) sw).caseAMpEmptyBracesFieldsetParametermapOptions(this);
    }
