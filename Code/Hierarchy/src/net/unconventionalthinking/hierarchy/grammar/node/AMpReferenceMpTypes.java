...
public final class AMpReferenceMpTypes extends PMpTypes
{
    ...
    public Object clone()
    {
        return new AMpReferenceMpTypes(
    ...
    {
        ((Analysis) sw).caseAMpReferenceMpTypes(this);
    }
