...
public final class AMpAllSubsetBodyOptions extends PSubsetBodyOptions
{
    private TStar _star_;

    public AMpAllSubsetBodyOptions()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpAllSubsetBodyOptions(
            cloneNode(this._star_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpAllSubsetBodyOptions(this);
    }
