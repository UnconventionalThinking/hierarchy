...
public final class AContinueStmtStatementWithoutTrailingSubstatement extends PStatementWithoutTrailingSubstatement
{
    private PContinueStatement _continueStatement_;

    public AContinueStmtStatementWithoutTrailingSubstatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AContinueStmtStatementWithoutTrailingSubstatement(
            cloneNode(this._continueStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAContinueStmtStatementWithoutTrailingSubstatement(this);
    }
