...
public final class AMpSetItemsChildren extends PSetItemsChildren
{
    private TComma _comma_;
    private PMatrixExpression _matrixExpression_;

    public AMpSetItemsChildren()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpSetItemsChildren(
    ...
    {
        ((Analysis) sw).caseAMpSetItemsChildren(this);
    }
