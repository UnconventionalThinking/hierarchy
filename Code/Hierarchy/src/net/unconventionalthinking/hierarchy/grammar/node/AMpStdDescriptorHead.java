...
public final class AMpStdDescriptorHead extends PDescriptorHead
{
    private PDescriptorHeadStd _descriptorHeadStd_;

    public AMpStdDescriptorHead()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpStdDescriptorHead(
            cloneNode(this._descriptorHeadStd_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpStdDescriptorHead(this);
    }
