...
public final class AMpIntMpIntegerLiteral extends PMpIntegerLiteral
{
    private TIntegerLiteral _integerLiteral_;

    public AMpIntMpIntegerLiteral()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpIntMpIntegerLiteral(
            cloneNode(this._integerLiteral_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpIntMpIntegerLiteral(this);
    }
