...
public final class AMpElementMpOutsideIncludedExprRelatedProdPlusId extends PMpOutsideIncludedExprRelatedProdPlusId
{
    private PMpOutsideIncludedExpressionRelatedProd _mpOutsideIncludedExpressionRelatedProd_;

    public AMpElementMpOutsideIncludedExprRelatedProdPlusId()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpElementMpOutsideIncludedExprRelatedProdPlusId(
            cloneNode(this._mpOutsideIncludedExpressionRelatedProd_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpElementMpOutsideIncludedExprRelatedProdPlusId(this);
    }
