...
public final class AMjOutsideIncludedVariableInitializer extends PVariableInitializer
{
    private PMpOutsideIncludedExpressionRelatedProd _mpOutsideIncludedExpressionRelatedProd_;

    public AMjOutsideIncludedVariableInitializer()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMjOutsideIncludedVariableInitializer(
            cloneNode(this._mpOutsideIncludedExpressionRelatedProd_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMjOutsideIncludedVariableInitializer(this);
    }
