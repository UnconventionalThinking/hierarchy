...
public final class AMpBodyMatrixKeySectionBody extends PMatrixKeySectionBody
{
    private TLBrc _lBrc_;
    private TRBrc _rBrc_;

    public AMpBodyMatrixKeySectionBody()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpBodyMatrixKeySectionBody(
    ...
    {
        ((Analysis) sw).caseAMpBodyMatrixKeySectionBody(this);
    }
