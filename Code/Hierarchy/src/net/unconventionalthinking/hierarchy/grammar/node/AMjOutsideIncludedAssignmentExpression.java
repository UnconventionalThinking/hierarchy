...
public final class AMjOutsideIncludedAssignmentExpression extends PAssignmentExpression
{
    private PMpOutsideIncludedExpressionRelatedProd _mpOutsideIncludedExpressionRelatedProd_;

    public AMjOutsideIncludedAssignmentExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMjOutsideIncludedAssignmentExpression(
            cloneNode(this._mpOutsideIncludedExpressionRelatedProd_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMjOutsideIncludedAssignmentExpression(this);
    }
