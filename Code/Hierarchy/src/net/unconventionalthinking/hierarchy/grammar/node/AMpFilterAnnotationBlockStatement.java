...
public final class AMpFilterAnnotationBlockStatement extends PAnnotationBlockStatement
{
    private PFilterStatement _filterStatement_;

    public AMpFilterAnnotationBlockStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpFilterAnnotationBlockStatement(
            cloneNode(this._filterStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpFilterAnnotationBlockStatement(this);
    }
