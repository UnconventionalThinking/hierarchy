...
public final class AMpPrivateMatrixAccessModifier extends PMatrixAccessModifier
{
    private TPrivate _private_;

    public AMpPrivateMatrixAccessModifier()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpPrivateMatrixAccessModifier(
            cloneNode(this._private_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpPrivateMatrixAccessModifier(this);
    }
