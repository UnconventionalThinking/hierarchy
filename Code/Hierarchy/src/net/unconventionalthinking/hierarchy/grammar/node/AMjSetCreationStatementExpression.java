...
public final class AMjSetCreationStatementExpression extends PStatementExpression
{
    private PSetInstanceCreation _setInstanceCreation_;

    public AMjSetCreationStatementExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMjSetCreationStatementExpression(
            cloneNode(this._setInstanceCreation_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMjSetCreationStatementExpression(this);
    }
