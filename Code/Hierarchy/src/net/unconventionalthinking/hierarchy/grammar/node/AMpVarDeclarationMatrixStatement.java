...
public final class AMpVarDeclarationMatrixStatement extends PMatrixStatement
{
    private PLocalVariableDeclarationStatement _localVariableDeclarationStatement_;

    public AMpVarDeclarationMatrixStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpVarDeclarationMatrixStatement(
            cloneNode(this._localVariableDeclarationStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpVarDeclarationMatrixStatement(this);
    }
