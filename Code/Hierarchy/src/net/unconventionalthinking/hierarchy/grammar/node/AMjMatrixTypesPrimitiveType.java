...
public final class AMjMatrixTypesPrimitiveType extends PPrimitiveType
{
    private PMpMatrixTypes _mpMatrixTypes_;

    public AMjMatrixTypesPrimitiveType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMjMatrixTypesPrimitiveType(
            cloneNode(this._mpMatrixTypes_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMjMatrixTypesPrimitiveType(this);
    }
