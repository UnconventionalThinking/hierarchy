...
public final class AMpHiddenDescriptorHeadHiddenTagname extends PDescriptorHeadHiddenTagname
{
    private PLabelname _labelname_;

    public AMpHiddenDescriptorHeadHiddenTagname()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpHiddenDescriptorHeadHiddenTagname(
            cloneNode(this._labelname_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpHiddenDescriptorHeadHiddenTagname(this);
    }
