...
public final class AMjAnnotationStatementStatementWithoutTrailingSubstatement extends PStatementWithoutTrailingSubstatement
{
    private PAnnotationStatement _annotationStatement_;

    public AMjAnnotationStatementStatementWithoutTrailingSubstatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMjAnnotationStatementStatementWithoutTrailingSubstatement(
            cloneNode(this._annotationStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMjAnnotationStatementStatementWithoutTrailingSubstatement(this);
    }
