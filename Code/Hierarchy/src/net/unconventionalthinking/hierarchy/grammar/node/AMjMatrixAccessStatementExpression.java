...
public final class AMjMatrixAccessStatementExpression extends PStatementExpression
{
    private PMatrixAccess _matrixAccess_;

    public AMjMatrixAccessStatementExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMjMatrixAccessStatementExpression(
            cloneNode(this._matrixAccess_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMjMatrixAccessStatementExpression(this);
    }
