 ...
 * @author peterjoh
 */
public class CmdAction_SymbolCreate_Label extends CmdAction {
    ...
    public void performAction(ExecutionInfo executeInfo, Command cmd) throws Exception {
        ...
        Label label = symbolControl.multiPartSymbol_Factory.createNew_Label(symbolParts, -1, false);

        objectIndex.put(cmd.logVarID, label);
