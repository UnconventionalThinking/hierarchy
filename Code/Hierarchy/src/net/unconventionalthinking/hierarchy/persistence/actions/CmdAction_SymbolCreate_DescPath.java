 ...
 * @author peterjoh
 */
public class CmdAction_SymbolCreate_DescPath extends CmdAction {

    @Override
    public void performAction(ExecutionInfo executeInfo, Command cmd) throws Exception {
        List<String> descPath_List = convertParamsToStringList(cmd.params);
        DescriptorPath symbol = symbolControl.multiLevelSymbol_Factory.createNew_DescriptorPath__usingPathStringList(descPath_List, false);
