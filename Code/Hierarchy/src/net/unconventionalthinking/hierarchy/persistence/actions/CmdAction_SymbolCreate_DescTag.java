 ...
 * @author peterjoh
 */
public class CmdAction_SymbolCreate_DescTag extends CmdAction {
    ...
    public void performAction(ExecutionInfo executeInfo, Command cmd) throws Exception {
        ...
        DescriptorTagName descTagName = (DescriptorTagName)objectIndex.get(((Integer)cmd.params[1]).intValue());
        DescriptorTag symbol = symbolControl.multiLevelSymbol_Factory.createNew_DescriptorTag(schemaName, descTagName, false);
