 ...
 * @author peterjoh
 */
public class CmdAction_SymbolCreate_MatrixName extends CmdAction {
    ...
    public void performAction(ExecutionInfo executeInfo, Command cmd) throws Exception {
        ...
        DescriptorTagName matrixName = (DescriptorTagName)objectIndex.get(((Integer)cmd.params[1]).intValue());
        MatrixName symbol = symbolControl.multiLevelSymbol_Factory.createNew_MatrixName(packageName, matrixName, false);
