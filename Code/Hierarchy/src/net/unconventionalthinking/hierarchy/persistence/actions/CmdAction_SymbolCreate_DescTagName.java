 ...
 * @author peterjoh
 */
public class CmdAction_SymbolCreate_DescTagName extends CmdAction {
    ...
    public void performAction(ExecutionInfo executeInfo, Command cmd) throws Exception {
        ...
        DescriptorTagName descTagName = symbolControl.multiPartSymbol_Factory.createNew_DescTagName(symbolParts, -1, false);

        objectIndex.put(cmd.logVarID, descTagName);
