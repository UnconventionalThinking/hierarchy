 ...
 *
 * usage:
 java -cp ../build/classes:../dist/lib/sablecc.jar net.unconventionalthinking.hierarchy.HierarchyMetaCompiler_SyntaxChecker -f ../testdata/input.txt
 *
...
public class HierarchyMetaCompiler_SyntaxChecker {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        tree.apply(new HierarchyMetaCompiler_SyntaxChecker_Actions());
...
class HierarchyMetaCompiler_SyntaxChecker_Actions extends DepthFirstAdapter {
