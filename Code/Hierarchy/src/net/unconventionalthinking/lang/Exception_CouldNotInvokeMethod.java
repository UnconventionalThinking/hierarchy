 ...
 * @author peterjoh
 */
public class Exception_CouldNotInvokeMethod extends RuntimeException {

    public Exception_CouldNotInvokeMethod(String message) {
        super(message);
    }
    public Exception_CouldNotInvokeMethod(String message, Throwable cause) {
        super(message, cause);
    }
}
