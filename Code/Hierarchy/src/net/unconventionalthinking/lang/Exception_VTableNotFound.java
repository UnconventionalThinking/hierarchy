 ...
 * @author peterjoh
 */
public class Exception_VTableNotFound extends RuntimeException {

    public Exception_VTableNotFound(String message) {
        super(message);
    }
    public Exception_VTableNotFound(String message, Throwable cause) {
        super(message, cause);
    }
}
