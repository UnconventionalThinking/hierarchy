 ...
 * @author peterjoh
 */
public class SchemaInfo_Descriptor_Impl extends Descriptor implements SchemaInfo_Descriptor {
     ...
     */
    SchemaInfo_Descriptor_Impl(ExecutionInfo executeInfo, SchemaInfo_Descriptor schemaInfo_Positioned, Label descriptorTagName_Label, 
        ...
        super(executeInfo,schemaInfo_Positioned, descriptorTagName_Label, uses_SchemaSet, parentDescriptor, schema_DescControl);
        schemaInfoDescriptor_Worker = new SchemaInfo_Descriptor_Worker(executeInfo, this);


        DescriptorTagName schemaInfo_DescriptorTagName = null;
        try {
            schemaInfo_DescriptorTagName = SymbolUtilities.convert_Label_to_DescTagName(descriptorTagName_Label, schema_DescControl.symbolControl);
        } catch (Exception e) {
        ...
        try {
            schemaInfo_DescriptorTag = schema_DescControl.symbolControl.multiLevelSymbol_Factory.createNew_DescriptorTag(
                ancestor_SchemaInfoSchema.getSchemaInfo_SchemaNameFull(), schemaInfo_DescriptorTagName, true);
        } catch (Exception e) {
            executeInfo.set_HadError();
            executeInfo.setErrorException(new Exception_SchemaInfo("Tried creating a SchemaInfo_descriptor, but had an error creating the descriptor tag for it.", e));
            throw (Exception_SchemaInfo) executeInfo.getErrorException();
        }

        canHave_FieldSet = false;
    ...
    public void     getSchemaInfo_DescTagName_FullPath(ExecutionInfo executeInfo, List<Symbol_Base> nameSymbols)
        { schemaInfoDescriptor_Worker.getSchemaInfo_DescTagName_FullPath(executeInfo, nameSymbols); }
    public String   getSchemaInfo_DescTagName_FullPath_String(ExecutionInfo executeInfo)
        { return schemaInfoDescriptor_Worker.getSchemaInfo_DescTagName_FullPath_String(executeInfo); }
    public String   getSchemaInfo_DescTagName_FullPath_IdentFormat(ExecutionInfo executeInfo)
        { return schemaInfoDescriptor_Worker.getSchemaInfo_DescTagName_FullPath_IdentFormat(executeInfo);}
