 ...
 * @author peterjoh
 */
public class Schema_for_SchemaForSchema__SchemaInfoDesc_FieldNames implements SchemaInfo_Descriptor {
    ...
    public Schema_for_SchemaForSchema__SchemaInfoDesc_FieldNames(ExecutionInfo executeInfo, SchemaInfo_Descriptor parent_SchemaInfoDescriptor,
        ...
        schemaInfoFieldSet = new SchemaInfo_FieldSet_FieldNames(executeInfo, schema_DescControl.symbolControl);
    ...
    public DescriptorTagName getSchemaInfo_DescriptorTagName() { return MPSymbols_DescTagName.FIELD$__$NAMES;    }
    public DescriptorTag getSchemaInfo_DescriptorTag() {
        return MPSymbols_DescTag.net$__$unconventionalthinking$__$matrix$_CC_$SCHEMA$95$FOR$95$$95$SCHEMA$95$FOR$95$SCHEMA$_CC_$FIELD$__$NAMES;
    }
    ...
    public void addChild_SchemaInfoDescriptor(ExecutionInfo executeInfo, SchemaInfo_Descriptor child_SchemaInfoDescriptor) throws Exception_Descriptor, Exception_SchemaInfo {
        throw new UnsupportedOperationException("This operation is not supported for the SchemaForSchema_SchemaInfoDescriptor_FieldNames obj.");
    }
    ...
    public void getSchemaInfo_DescTagName_FullPath(ExecutionInfo executeInfo, List<Symbol_Base> nameSymbols) {
        ...
        nameSymbols.add(MPSymbols_DescTagName.FIELD$__$NAMES);
    }
    public String getSchemaInfo_DescTagName_FullPath_String(ExecutionInfo executeInfo) {
        return (parent_SchemaInfoDescriptor.getSchemaInfo_DescTagName_FullPath_String(executeInfo) + SymbolConstants.SymbolPath_SymbolSeparator +
            ((Symbol)MPSymbols_DescTagName.FIELD$__$NAMES).name_MultiPart.name_no_backtiks);
    }
    public String getSchemaInfo_DescTagName_FullPath_IdentFormat(ExecutionInfo executeInfo) {
        return (parent_SchemaInfoDescriptor.getSchemaInfo_DescTagName_FullPath_IdentFormat(executeInfo) + SymbolConstants.SymbolPath_SymbolSeparator_IdentFormat +
            ((Symbol)MPSymbols_DescTagName.FIELD$__$NAMES).name_IdentFormat);
    }
    ...
    public class SchemaInfo_FieldSet_FieldNames extends SchemaInfo_FieldSet {

        public SchemaInfo_Field schemaInfoField_FieldNames;

        public SchemaInfo_FieldSet_FieldNames(ExecutionInfo executeInfo, SymbolControl symbolControl) throws Exception_SchemaInfo {
            super(executeInfo, Schema_for_SchemaForSchema__SchemaInfoDesc_FieldNames.this); // want to pass the outer object reference.
            ...
            schemaInfoField_FieldNames = new SchemaInfo_Field(executeInfo, 0, this, SchemaConstants.Schema_4_Schema4Schema__FieldName_for_FieldNames,
                    MPSymbols.ContinuationType$__$DescriptorTagName, symbolControl, null, null);
            schemaInfoFields_List.add(schemaInfoField_FieldNames);
            schemaInfoFields_Index.put(SchemaConstants.Schema_4_Schema4Schema__FieldName_for_FieldNames, schemaInfoField_FieldNames);
