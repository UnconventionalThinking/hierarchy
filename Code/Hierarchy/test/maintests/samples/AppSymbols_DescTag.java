...
public class AppSymbols_DescTag { 
	...
	public static DescriptorTag maintests$__$samples$_CC_$Test$__$Schema$_CC_$TEST$__$DESC;
	public static DescriptorTag maintests$__$samples$_CC_$Test$__$Schema$_CC_$CHILD$__$DESC;
	public static DescriptorTag maintests$__$samples$_CC_$Test$__$Schema$_CC_$TEST$__$OBJECT$__$TYPES;
	public static DescriptorTag maintests$__$samples$_CC_$Test$__$Schema$_CC_$TEST$__$IMPORTING$__$TYPES;
	public static DescriptorTag maintests$__$samples$_CC_$Web$__$Content$_CC_$PAGE$__$INFO;
	public static DescriptorTag maintests$__$samples$_CC_$Web$__$Content$_CC_$NEWS;
	public static DescriptorTag maintests$__$samples$_CC_$Web$__$Content$_CC_$NEWS$__$STORY;
	public static DescriptorTag maintests$__$samples$_CC_$Web$__$Content$_CC_$PEOPLE;
	public static DescriptorTag maintests$__$samples$_CC_$Web$__$Content$_CC_$PERSON$__$INFO;
	public static DescriptorTag maintests$__$samples$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED;
	public static DescriptorTag maintests$__$samples$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECTOR;
	public static DescriptorTag maintests$__$samples$_CC_$WEB$__$FORM$_CC_$OPTION;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR__SCHEMA_FOR_SCHEMA::SCHEMA
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR__SCHEMA_FOR_SCHEMA::DESCRIPTOR
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR__SCHEMA_FOR_SCHEMA::`FIELD`.`NAMES`
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR__SCHEMA_FOR_SCHEMA::`FIELD`.`TYPES`
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR_SCHEMA::SCHEMA
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR_SCHEMA::DESCRIPTOR
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR_SCHEMA::ITEM
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR_SCHEMA::MATRIX
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR_SCHEMA::`FIELD`.`NAMES`
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR_SCHEMA::`FIELD`.`TYPES`
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR_SCHEMA::`FIELD`.`DESC`
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR_SCHEMA::`FIELD`.`DEFAULTS`
		...
		//  `net`.`unconventionalthinking`.`matrix`::`MATRIX`.`BASE`::MATRIX
		...
		//  `net`.`unconventionalthinking`.`matrix`::`MATRIX`.`STANDARD`::ITEM
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR__SCHEMA_FOR_SCHEMA::MATRIX
		...
		//  `net`.`unconventionalthinking`.`matrix`::SCHEMA_FOR__SCHEMA_FOR_SCHEMA::ITEM
		...
		//  `maintests`.`samples`::`Test`.`Schema`::`TEST`.`DESC`

		maintests$__$samples$_CC_$Test$__$Schema$_CC_$TEST$__$DESC = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$Test$__$Schema, AppSymbols_DescTagName.TEST$__$DESC,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`Test`.`Schema`::`CHILD`.`DESC`

		maintests$__$samples$_CC_$Test$__$Schema$_CC_$CHILD$__$DESC = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$Test$__$Schema, AppSymbols_DescTagName.CHILD$__$DESC,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`Test`.`Schema`::`TEST`.`OBJECT`.`TYPES`

		maintests$__$samples$_CC_$Test$__$Schema$_CC_$TEST$__$OBJECT$__$TYPES = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$Test$__$Schema, AppSymbols_DescTagName.TEST$__$OBJECT$__$TYPES,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`Test`.`Schema`::`TEST`.`IMPORTING`.`TYPES`

		maintests$__$samples$_CC_$Test$__$Schema$_CC_$TEST$__$IMPORTING$__$TYPES = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$Test$__$Schema, AppSymbols_DescTagName.TEST$__$IMPORTING$__$TYPES,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`Web`.`Content`::`PAGE`.`INFO`

		maintests$__$samples$_CC_$Web$__$Content$_CC_$PAGE$__$INFO = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$Web$__$Content, AppSymbols_DescTagName.PAGE$__$INFO,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`Web`.`Content`::NEWS

		maintests$__$samples$_CC_$Web$__$Content$_CC_$NEWS = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$Web$__$Content, AppSymbols_DescTagName.NEWS,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`Web`.`Content`::`NEWS`.`STORY`

		maintests$__$samples$_CC_$Web$__$Content$_CC_$NEWS$__$STORY = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$Web$__$Content, AppSymbols_DescTagName.NEWS$__$STORY,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`Web`.`Content`::PEOPLE

		maintests$__$samples$_CC_$Web$__$Content$_CC_$PEOPLE = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$Web$__$Content, AppSymbols_DescTagName.PEOPLE,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`Web`.`Content`::`PERSON`.`INFO`

		maintests$__$samples$_CC_$Web$__$Content$_CC_$PERSON$__$INFO = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$Web$__$Content, AppSymbols_DescTagName.PERSON$__$INFO,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`WEB`.`FORM`::`FORM`.`REQUIRED`

		maintests$__$samples$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$REQUIRED,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`WEB`.`FORM`::`FORM`.`SELECTOR`

		maintests$__$samples$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECTOR = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$SELECTOR,creation_Has_StaticVersion);

		//  `maintests`.`samples`::`WEB`.`FORM`::OPTION

		maintests$__$samples$_CC_$WEB$__$FORM$_CC_$OPTION = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$_CC_$WEB$__$FORM, AppSymbols_DescTagName.OPTION,creation_Has_StaticVersion);
