...
public final class APrimaryMpPrePrimary extends PMpPrePrimary
{
    private PPrimary _primary_;

    public APrimaryMpPrePrimary()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrimaryMpPrePrimary(
            cloneNode(this._primary_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAPrimaryMpPrePrimary(this);
    }
