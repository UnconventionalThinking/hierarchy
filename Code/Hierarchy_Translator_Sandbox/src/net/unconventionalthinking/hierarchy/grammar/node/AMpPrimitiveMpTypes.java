...
public final class AMpPrimitiveMpTypes extends PMpTypes
{
    ...
    public Object clone()
    {
        return new AMpPrimitiveMpTypes(
    ...
    {
        ((Analysis) sw).caseAMpPrimitiveMpTypes(this);
    }
