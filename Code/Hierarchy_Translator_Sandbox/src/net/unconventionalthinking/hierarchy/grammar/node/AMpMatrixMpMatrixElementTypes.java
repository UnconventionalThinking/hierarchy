...
public final class AMpMatrixMpMatrixElementTypes extends PMpMatrixElementTypes
{
    private TMpMatrixKeyword _mpMatrixKeyword_;

    public AMpMatrixMpMatrixElementTypes()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpMatrixMpMatrixElementTypes(
            cloneNode(this._mpMatrixKeyword_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpMatrixMpMatrixElementTypes(this);
    }
