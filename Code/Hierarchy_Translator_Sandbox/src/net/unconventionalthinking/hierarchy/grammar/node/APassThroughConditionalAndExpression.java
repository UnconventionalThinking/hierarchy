...
public final class APassThroughConditionalAndExpression extends PConditionalAndExpression
{
    private PEqualityExpression _equalityExpression_;

    public APassThroughConditionalAndExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APassThroughConditionalAndExpression(
            cloneNode(this._equalityExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAPassThroughConditionalAndExpression(this);
    }
