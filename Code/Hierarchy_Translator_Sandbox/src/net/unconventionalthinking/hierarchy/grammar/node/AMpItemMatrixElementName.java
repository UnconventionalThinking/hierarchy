...
public final class AMpItemMatrixElementName extends PMatrixElementName
{
    private TMpItemKeyword _mpItemKeyword_;

    public AMpItemMatrixElementName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpItemMatrixElementName(
            cloneNode(this._mpItemKeyword_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpItemMatrixElementName(this);
    }
