...
public final class AMpAnnotationUseage extends PAnnotationUseage
{
    private PAnnotationNameOptions _annotationNameOptions_;

    public AMpAnnotationUseage()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpAnnotationUseage(
            cloneNode(this._annotationNameOptions_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpAnnotationUseage(this);
    }
