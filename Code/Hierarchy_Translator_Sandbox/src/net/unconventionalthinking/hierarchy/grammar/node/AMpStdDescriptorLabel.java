...
public final class AMpStdDescriptorLabel extends PDescriptorLabel
{
    private PLabelname _labelname_;

    public AMpStdDescriptorLabel()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpStdDescriptorLabel(
            cloneNode(this._labelname_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpStdDescriptorLabel(this);
    }
