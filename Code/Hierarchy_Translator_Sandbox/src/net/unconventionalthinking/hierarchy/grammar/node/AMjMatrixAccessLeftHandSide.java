...
public final class AMjMatrixAccessLeftHandSide extends PLeftHandSide
{
    private PMatrixAccess _matrixAccess_;

    public AMjMatrixAccessLeftHandSide()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMjMatrixAccessLeftHandSide(
            cloneNode(this._matrixAccess_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMjMatrixAccessLeftHandSide(this);
    }
