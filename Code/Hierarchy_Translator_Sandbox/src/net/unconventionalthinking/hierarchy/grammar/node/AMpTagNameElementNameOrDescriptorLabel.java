...
public final class AMpTagNameElementNameOrDescriptorLabel extends PElementNameOrDescriptorLabel
{
    private PMatrixElementName _matrixElementName_;

    public AMpTagNameElementNameOrDescriptorLabel()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpTagNameElementNameOrDescriptorLabel(
            cloneNode(this._matrixElementName_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpTagNameElementNameOrDescriptorLabel(this);
    }
