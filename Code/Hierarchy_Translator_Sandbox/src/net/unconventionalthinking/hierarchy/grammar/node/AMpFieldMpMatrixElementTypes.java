...
public final class AMpFieldMpMatrixElementTypes extends PMpMatrixElementTypes
{
    private TMpFieldKeyword _mpFieldKeyword_;

    public AMpFieldMpMatrixElementTypes()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpFieldMpMatrixElementTypes(
            cloneNode(this._mpFieldKeyword_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpFieldMpMatrixElementTypes(this);
    }
