...
public final class AMpEmptyItemNewBodyOptions extends PItemNewBodyOptions
{
    private TLBrc _lBrc_;
    private TRBrc _rBrc_;

    public AMpEmptyItemNewBodyOptions()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpEmptyItemNewBodyOptions(
    ...
    {
        ((Analysis) sw).caseAMpEmptyItemNewBodyOptions(this);
    }
