...
public final class AMjOneOutsideIncludedArgumentList extends PArgumentList
{
    private PMpOutsideIncludedExpressionRelatedProd _mpOutsideIncludedExpressionRelatedProd_;

    public AMjOneOutsideIncludedArgumentList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMjOneOutsideIncludedArgumentList(
            cloneNode(this._mpOutsideIncludedExpressionRelatedProd_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMjOneOutsideIncludedArgumentList(this);
    }
