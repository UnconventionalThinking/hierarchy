...
public final class AMpLabelnameBacktiksChildren extends PLabelnameBacktiksChildren
{
    private TDot _dot_;
    private TMpSymbolLiteralBacktiks _mpSymbolLiteralBacktiks_;

    public AMpLabelnameBacktiksChildren()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpLabelnameBacktiksChildren(
    ...
    {
        ((Analysis) sw).caseAMpLabelnameBacktiksChildren(this);
    }
