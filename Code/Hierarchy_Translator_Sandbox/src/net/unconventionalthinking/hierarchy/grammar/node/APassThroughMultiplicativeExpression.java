...
public final class APassThroughMultiplicativeExpression extends PMultiplicativeExpression
{
    private PUnaryExpression _unaryExpression_;

    public APassThroughMultiplicativeExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APassThroughMultiplicativeExpression(
            cloneNode(this._unaryExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAPassThroughMultiplicativeExpression(this);
    }
