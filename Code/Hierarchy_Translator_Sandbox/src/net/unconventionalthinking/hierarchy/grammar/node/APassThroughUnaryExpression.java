...
public final class APassThroughUnaryExpression extends PUnaryExpression
{
    private PPostfixExpression _postfixExpression_;

    public APassThroughUnaryExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APassThroughUnaryExpression(
            cloneNode(this._postfixExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAPassThroughUnaryExpression(this);
    }
