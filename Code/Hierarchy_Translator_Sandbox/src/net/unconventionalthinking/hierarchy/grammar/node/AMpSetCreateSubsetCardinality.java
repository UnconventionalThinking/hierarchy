...
public final class AMpSetCreateSubsetCardinality extends PSetCreateSubsetCardinality
{
    ...
    public AMpSetCreateSubsetCardinality()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpSetCreateSubsetCardinality(
    ...
    {
        ((Analysis) sw).caseAMpSetCreateSubsetCardinality(this);
    }
