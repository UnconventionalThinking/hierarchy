...
public final class ASwitchStatementStatement extends PStatement
{
    private PSwitchStatement _switchStatement_;

    public ASwitchStatementStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASwitchStatementStatement(
            cloneNode(this._switchStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseASwitchStatementStatement(this);
    }
