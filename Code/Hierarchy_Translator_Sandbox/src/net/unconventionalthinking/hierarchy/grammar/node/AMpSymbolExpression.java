...
public final class AMpSymbolExpression extends PSymbolExpression
{
    private PMatrixExpression _matrixExpression_;

    public AMpSymbolExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpSymbolExpression(
            cloneNode(this._matrixExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpSymbolExpression(this);
    }
