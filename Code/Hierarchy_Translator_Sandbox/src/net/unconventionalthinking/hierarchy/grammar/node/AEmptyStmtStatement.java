...
public final class AEmptyStmtStatement extends PStatement
{
    private PEmptyStatement _emptyStatement_;

    public AEmptyStmtStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEmptyStmtStatement(
            cloneNode(this._emptyStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAEmptyStmtStatement(this);
    }
