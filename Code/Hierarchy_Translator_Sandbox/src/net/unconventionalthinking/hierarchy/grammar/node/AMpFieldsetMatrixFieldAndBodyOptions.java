...
public final class AMpFieldsetMatrixFieldAndBodyOptions extends PMatrixFieldAndBodyOptions
{
    private PFieldsetParametermapWColon _fieldsetParametermapWColon_;
    private TSemi _semi_;

    public AMpFieldsetMatrixFieldAndBodyOptions()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpFieldsetMatrixFieldAndBodyOptions(
    ...
    {
        ((Analysis) sw).caseAMpFieldsetMatrixFieldAndBodyOptions(this);
    }
