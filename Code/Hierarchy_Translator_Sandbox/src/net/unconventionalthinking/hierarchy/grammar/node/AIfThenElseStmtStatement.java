...
public final class AIfThenElseStmtStatement extends PStatement
{
    private PIfThenElseStatement _ifThenElseStatement_;

    public AIfThenElseStmtStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIfThenElseStmtStatement(
            cloneNode(this._ifThenElseStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAIfThenElseStmtStatement(this);
    }
