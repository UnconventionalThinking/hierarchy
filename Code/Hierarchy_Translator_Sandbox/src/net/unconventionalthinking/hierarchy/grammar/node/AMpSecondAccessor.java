...
public final class AMpSecondAccessor extends PSecondAccessor
{
    private PMatrixExpression _matrixExpression_;

    public AMpSecondAccessor()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpSecondAccessor(
            cloneNode(this._matrixExpression_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpSecondAccessor(this);
    }
