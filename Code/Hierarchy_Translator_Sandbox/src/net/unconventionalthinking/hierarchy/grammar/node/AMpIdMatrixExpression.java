...
public final class AMpIdMatrixExpression extends PMatrixExpression
{
    ...
    public Object clone()
    {
        return new AMpIdMatrixExpression(
    ...
    {
        ((Analysis) sw).caseAMpIdMatrixExpression(this);
    }
