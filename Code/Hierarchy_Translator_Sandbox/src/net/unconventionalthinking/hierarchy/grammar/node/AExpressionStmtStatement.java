...
public final class AExpressionStmtStatement extends PStatement
{
    private PExpressionStatement _expressionStatement_;

    public AExpressionStmtStatement()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpressionStmtStatement(
            cloneNode(this._expressionStatement_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAExpressionStmtStatement(this);
    }
