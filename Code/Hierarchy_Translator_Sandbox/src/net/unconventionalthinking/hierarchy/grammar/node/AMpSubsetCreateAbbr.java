...
public final class AMpSubsetCreateAbbr extends PSubsetCreateAbbr
{
    private TLBrc _lBrc_;
    private PSubsetBodyOptions _subsetBodyOptions_;
    private TRBrc _rBrc_;

    public AMpSubsetCreateAbbr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpSubsetCreateAbbr(
    ...
    {
        ((Analysis) sw).caseAMpSubsetCreateAbbr(this);
    }
