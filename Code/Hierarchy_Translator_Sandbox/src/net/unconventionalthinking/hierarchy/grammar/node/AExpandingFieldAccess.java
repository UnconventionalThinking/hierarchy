...
public final class AExpandingFieldAccess extends PFieldAccess
{
    private PPrimary _primary_;
    private TDot _dot_;
    private TIdentifier _identifier_;

    public AExpandingFieldAccess()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpandingFieldAccess(
    ...
    {
        ((Analysis) sw).caseAExpandingFieldAccess(this);
    }
