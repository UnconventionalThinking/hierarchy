...
public final class AContinuationOperator extends PContinuationOperator
{
    private TDotDotDot _dotDotDot_;

    public AContinuationOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AContinuationOperator(
            cloneNode(this._dotDotDot_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAContinuationOperator(this);
    }
