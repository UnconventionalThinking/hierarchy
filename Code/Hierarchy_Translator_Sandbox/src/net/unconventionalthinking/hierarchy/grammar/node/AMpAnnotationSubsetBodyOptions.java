...
public final class AMpAnnotationSubsetBodyOptions extends PSubsetBodyOptions
{
    private PAnnotationUseage _annotationUseage_;

    public AMpAnnotationSubsetBodyOptions()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMpAnnotationSubsetBodyOptions(
            cloneNode(this._annotationUseage_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAMpAnnotationSubsetBodyOptions(this);
    }
