...
public final class AMpDeclarationDescriptorDeclaration extends PDescriptorDeclaration
{
    private PDescriptorHeadOptions _descriptorHeadOptions_;
    private PUsesSchemas _usesSchemas_;
    private PDescriptorFieldAndBodyOptions _descriptorFieldAndBodyOptions_;
    private TSemi _semi_;

    public AMpDeclarationDescriptorDeclaration()
    {
        // Constructor
    }

    public AMpDeclarationDescriptorDeclaration(
        @SuppressWarnings("hiding") PDescriptorHeadOptions _descriptorHeadOptions_,
    ...
    {
        // Constructor
        setDescriptorHeadOptions(_descriptorHeadOptions_);
    ...
    public Object clone()
    {
        return new AMpDeclarationDescriptorDeclaration(
            cloneNode(this._descriptorHeadOptions_),
    ...
    {
        ((Analysis) sw).caseAMpDeclarationDescriptorDeclaration(this);
    }

    public PDescriptorHeadOptions getDescriptorHeadOptions()
    {
        return this._descriptorHeadOptions_;
    }

    public void setDescriptorHeadOptions(PDescriptorHeadOptions node)
    {
        if(this._descriptorHeadOptions_ != null)
        {
            this._descriptorHeadOptions_.parent(null);
        }
        ...
        this._descriptorHeadOptions_ = node;
    }
    ...
    {
        return ""
            + toString(this._descriptorHeadOptions_)
    ...
    {
        // Remove child
        if(this._descriptorHeadOptions_ == child)
        {
            this._descriptorHeadOptions_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._descriptorHeadOptions_ == oldChild)
        {
            setDescriptorHeadOptions((PDescriptorHeadOptions) newChild);
            return;
        }
