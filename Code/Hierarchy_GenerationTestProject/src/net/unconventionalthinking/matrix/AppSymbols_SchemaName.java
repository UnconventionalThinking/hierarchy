...
public class AppSymbols_SchemaName { 
	...
	public static MatrixName net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM;
	public static MatrixName net$__$unconventionalthinking$__$matrix$_CC_$TEST$__$SCHEMA;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  `net`.`unconventionalthinking`.`matrix`::`WEB`.`FORM`

		net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM = multiLevelSymbol_Factory.createNew_SchemaName(AppSymbols_DescTagName.net$__$unconventionalthinking$__$matrix, AppSymbols_DescTagName.WEB$__$FORM,creation_Has_StaticVersion);

		//  `net`.`unconventionalthinking`.`matrix`::`TEST`.`SCHEMA`

		net$__$unconventionalthinking$__$matrix$_CC_$TEST$__$SCHEMA = multiLevelSymbol_Factory.createNew_SchemaName(AppSymbols_DescTagName.net$__$unconventionalthinking$__$matrix, AppSymbols_DescTagName.TEST$__$SCHEMA,creation_Has_StaticVersion);
