...
public class AppSymbols_DescTag { 
	...
	public static DescriptorTag net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED;
	public static DescriptorTag net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECT;
	public static DescriptorTag net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM$_CC_$OPTION;
	public static DescriptorTag net$__$unconventionalthinking$__$matrix$_CC_$TEST$__$SCHEMA$_CC_$MY$95$DESC$__$NUM1;
	public static DescriptorTag net$__$unconventionalthinking$__$matrix$_CC_$TEST$__$SCHEMA$_CC_$MY$95$DESC$__$NUM2;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  `net`.`unconventionalthinking`.`matrix`::`WEB`.`FORM`::`FORM`.`REQUIRED`

		net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$REQUIRED,creation_Has_StaticVersion);

		//  `net`.`unconventionalthinking`.`matrix`::`WEB`.`FORM`::`FORM`.`SELECT`

		net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECT = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$SELECT,creation_Has_StaticVersion);

		//  `net`.`unconventionalthinking`.`matrix`::`WEB`.`FORM`::OPTION

		net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM$_CC_$OPTION = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.net$__$unconventionalthinking$__$matrix$_CC_$WEB$__$FORM, AppSymbols_DescTagName.OPTION,creation_Has_StaticVersion);

		//  `net`.`unconventionalthinking`.`matrix`::`TEST`.`SCHEMA`::`MY_DESC`.`NUM1`

		net$__$unconventionalthinking$__$matrix$_CC_$TEST$__$SCHEMA$_CC_$MY$95$DESC$__$NUM1 = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.net$__$unconventionalthinking$__$matrix$_CC_$TEST$__$SCHEMA, AppSymbols_DescTagName.MY$95$DESC$__$NUM1,creation_Has_StaticVersion);

		//  `net`.`unconventionalthinking`.`matrix`::`TEST`.`SCHEMA`::`MY_DESC`.`NUM2`

		net$__$unconventionalthinking$__$matrix$_CC_$TEST$__$SCHEMA$_CC_$MY$95$DESC$__$NUM2 = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.net$__$unconventionalthinking$__$matrix$_CC_$TEST$__$SCHEMA, AppSymbols_DescTagName.MY$95$DESC$__$NUM2,creation_Has_StaticVersion);
