...
public  class EmbeddedCodeTest implements EmbeddedCodeTest__Annotations {
	...
	@ Test public void testAccess ( ) throws Exception {
		String resultString = EmbeddedCodeTest__MatrixWorker.accessMatrix_Test$__$Matrix__17(executeInfo, this);
		assertEquals ( requiredImagePath_Expected , resultString ) ;
		Symbol resultSymbol = ( Symbol ) EmbeddedCodeTest__MatrixWorker.accessMatrix_Test$__$Matrix2__18(executeInfo, maintests.samples.typeinfotest.Test$__$Matrix2.matrix, this, AppSymbols_Label.test$32$item, AppSymbols_DescTagName.TEST$__$DESC, AppSymbols_DescTagName.testField1);
		assertEquals ( AppSymbols.testSym1 , resultSymbol ) ;
		resultSymbol  = ( Symbol ) EmbeddedCodeTest__MatrixWorker.accessMatrix_Test$__$Matrix2$95$1__19(executeInfo, maintests.samples.typeinfotest.Test$__$Matrix2$95$1.matrix, this, AppSymbols_Label.test$32$item, AppSymbols_DescTagName.TEST$__$DESC, AppSymbols_DescTagName.testField1);
		assertEquals ( AppSymbols.testSym2 , resultSymbol ) ;
		FieldSet formRequired_FieldSet = ( EmbeddedCodeTest__MatrixWorker.accessMatrix_Test$__$Matrix__20(executeInfo, this)) . get_FieldSet ( ) ;
