...
public class EmbeddedCodeTest_ImportedPackage_Test__MatrixWorker {
	...
	public static String accessMatrix_Test$__$Matrix3__21(ExecutionInfo executeInfo, EmbeddedCodeTest_ImportedPackage_Test__Annotations callerObj) {

		//  Static Descriptor Access by Static Label, First Name.
		Descriptor Descriptor__97__STATIC__LBL_First$32$Name = null;

		if (DescriptorUtilities.validDescriptors(executeInfo, maintests.samples.typeinfotest.anotherpackage.Test$__$Matrix3.matrix)) {
			try{
				Descriptor__97__STATIC__LBL_First$32$Name = maintests.samples.typeinfotest.anotherpackage.Test$__$Matrix3.matrix.get_ChildDescriptor(executeInfo, AppSymbols_Label.First$32$Name);
			} catch (Exception e) {
		...
		if (executeInfo.get_HadError()) {
			...
			if (accessReturnType_OutParam != null && accessReturnType_OutParam.returnType == AnnotationParameters.AccessReturnType.accessorValue)
				Descriptor__97__STATIC__LBL_First$32$Name = (Descriptor)annotateRetVal;
		...
		Descriptor Descriptor__98__STATIC__DTAGNAME_FORM$__$REQUIRED = null;

		if (DescriptorUtilities.validDescriptors(executeInfo, Descriptor__97__STATIC__LBL_First$32$Name)) {
			try{
				Descriptor__98__STATIC__DTAGNAME_FORM$__$REQUIRED = Descriptor__97__STATIC__LBL_First$32$Name.get_ChildDescriptor(executeInfo, AppSymbols_DescTagName.FORM$__$REQUIRED);
			} catch (Exception e) {
				executeInfo.setErrorException(e);
			}
		...
		if (executeInfo.get_HadError()) {
			...
			if (accessReturnType_OutParam != null && accessReturnType_OutParam.returnType == AnnotationParameters.AccessReturnType.accessorValue)
				Descriptor__98__STATIC__DTAGNAME_FORM$__$REQUIRED = (Descriptor)annotateRetVal;
			else // accessReturnType_OutParam.returnType == AnnotationParameters.AccessReturnType.accessValue)
				return (String)annotateRetVal;
		}
		...
		if (DescriptorUtilities.validDescriptors(executeInfo, Descriptor__98__STATIC__DTAGNAME_FORM$__$REQUIRED)) {
			try{
				if (Descriptor__98__STATIC__DTAGNAME_FORM$__$REQUIRED.has_FieldSet()) {
					return ((maintests.samples.typeinfotest.FieldSetTuple__maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM$_S_$FORM$__$REQUIRED)Descriptor__98__STATIC__DTAGNAME_FORM$__$REQUIRED.get_FieldSet()).get_RequiredImagePath(executeInfo);
				} else {
	...
	public static Descriptor accessMatrix_Test$__$Matrix3__22(ExecutionInfo executeInfo, EmbeddedCodeTest_ImportedPackage_Test__Annotations callerObj) {
		...
		if (DescriptorUtilities.validDescriptors(executeInfo, maintests.samples.typeinfotest.anotherpackage.Test$__$Matrix3.matrix)) {
			try{
				Descriptor__100__STATIC__LBL_First$32$Name = maintests.samples.typeinfotest.anotherpackage.Test$__$Matrix3.matrix.get_ChildDescriptor(executeInfo, AppSymbols_Label.First$32$Name);
			} catch (Exception e) {
				executeInfo.setErrorException(e);
			}
