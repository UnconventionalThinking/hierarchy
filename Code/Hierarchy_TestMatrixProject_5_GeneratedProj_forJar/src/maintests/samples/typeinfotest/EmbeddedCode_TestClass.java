...
public  class EmbeddedCode_TestClass implements EmbeddedCode_TestClass__Annotations {
	...
	public void testAccess ( ) throws Exception {
		String resultString = EmbeddedCode_TestClass__MatrixWorker.accessMatrix_Test$__$Matrix__23(executeInfo, this);
		assertEquals ( requiredImagePath_Expected , resultString ) ;
		FieldSet formRequired_FieldSet = ( EmbeddedCode_TestClass__MatrixWorker.accessMatrix_Test$__$Matrix__24(executeInfo, this)) . get_FieldSet ( ) ;
