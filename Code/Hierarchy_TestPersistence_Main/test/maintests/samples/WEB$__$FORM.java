...
public class WEB$__$FORM implements SchemaContainer {
	...
	public static SchemaInfo_Schema construct(AppControl_Base appControl, ExecutionInfo executeInfo)
		...
		try {
			...
			descriptor0$_X_$SCHEMA = (Descriptor)appControl.schemaControl.schemaFactory.createNew_Schema(executeInfo, AppSymbols_Label.WEB$__$FORM, AppSymbols_DescTagName.maintests$__$samples, true, descriptor0$_X_$SCHEMA$_X_$__UsesSchemaSet, null, true);
