...
public  class EmbeddedCodeTest_ImportedPackage_Test implements EmbeddedCodeTest_ImportedPackage_Test__Annotations {
	...
	@ Test public void testImportedMatrixAccess ( ) throws Exception {
		String resultString = EmbeddedCodeTest_ImportedPackage_Test__MatrixWorker.accessMatrix_Test$__$Matrix3__23(executeInfo, this);
		assertEquals ( requiredImagePath_Expected , resultString ) ;
		FieldSet formRequired_FieldSet = ( EmbeddedCodeTest_ImportedPackage_Test__MatrixWorker.accessMatrix_Test$__$Matrix3__24(executeInfo, this)) . get_FieldSet ( ) ;
