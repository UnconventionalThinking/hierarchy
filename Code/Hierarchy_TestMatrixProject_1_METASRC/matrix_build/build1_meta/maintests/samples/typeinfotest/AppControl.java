...
public class AppControl extends AppControl_Base { 
	...
	void initialize_StaticSchemas() throws Exception_MatrixRuntime_Checked {
		maintests.samples.typeinfotest.WEB$__$FORM.construct(this, executionInfo);
		maintests.samples.typeinfotest.anotherpackage.Test$__$Schema.construct(this, executionInfo);

	}

	//  construct static Matrices
	void initialize_StaticMatrices() throws Exception_MatrixRuntime_Checked {
		maintests.samples.typeinfotest.Test$__$Matrix.construct(this, executionInfo);
		maintests.samples.typeinfotest.Test$__$Matrix2.construct(this, executionInfo);
		maintests.samples.typeinfotest.Test$__$Matrix2$95$1.construct(this, executionInfo);
		maintests.samples.typeinfotest.anotherpackage.Test$__$Matrix3.construct(this, executionInfo);
