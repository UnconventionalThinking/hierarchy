...
public class AppSymbols_DescTag { 
	...
	public static DescriptorTag maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED;
	public static DescriptorTag maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECTOR;
	public static DescriptorTag maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM$_CC_$OPTION;
	public static DescriptorTag maintests$__$samples$__$typeinfotest$__$anotherpackage$_CC_$Test$__$Schema$_CC_$TEST$__$DESC;
	public static DescriptorTag maintests$__$samples$__$typeinfotest$__$anotherpackage$_CC_$Test$__$Schema$_CC_$CHILD$__$DESC;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  `maintests`.`samples`.`typeinfotest`::`WEB`.`FORM`::`FORM`.`REQUIRED`

		maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$REQUIRED,creation_Has_StaticVersion);

		//  `maintests`.`samples`.`typeinfotest`::`WEB`.`FORM`::`FORM`.`SELECTOR`

		maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECTOR = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$SELECTOR,creation_Has_StaticVersion);

		//  `maintests`.`samples`.`typeinfotest`::`WEB`.`FORM`::OPTION

		maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM$_CC_$OPTION = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$__$typeinfotest$_CC_$WEB$__$FORM, AppSymbols_DescTagName.OPTION,creation_Has_StaticVersion);

		//  `maintests`.`samples`.`typeinfotest`.`anotherpackage`::`Test`.`Schema`::`TEST`.`DESC`

		maintests$__$samples$__$typeinfotest$__$anotherpackage$_CC_$Test$__$Schema$_CC_$TEST$__$DESC = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$__$typeinfotest$__$anotherpackage$_CC_$Test$__$Schema, AppSymbols_DescTagName.TEST$__$DESC,creation_Has_StaticVersion);

		//  `maintests`.`samples`.`typeinfotest`.`anotherpackage`::`Test`.`Schema`::`CHILD`.`DESC`

		maintests$__$samples$__$typeinfotest$__$anotherpackage$_CC_$Test$__$Schema$_CC_$CHILD$__$DESC = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$__$typeinfotest$__$anotherpackage$_CC_$Test$__$Schema, AppSymbols_DescTagName.CHILD$__$DESC,creation_Has_StaticVersion);
