...
public class AppSymbols_Label { 
	...
	public static final int WEB$_ID_$ = 512;
	public static Label FORM;
	public static final int FORM$_ID_$ = 513;
	public static Label REQUIRED;
	public static final int REQUIRED$_ID_$ = 514;
	public static Label SELECTOR;
	public static final int SELECTOR$_ID_$ = 515;
	public static Label OPTION;
	public static final int OPTION$_ID_$ = 516;
	public static Label Test;
	public static final int Test$_ID_$ = 517;
	public static Label Schema;
	public static final int Schema$_ID_$ = 518;
	public static Label CHILD;
	public static final int CHILD$_ID_$ = 519;
	public static Label Matrix;
	public static final int Matrix$_ID_$ = 520;
	public static Label First$32$Name;
	public static final int First$32$Name$_ID_$ = 521;
	public static Label Last$32$Name;
	public static final int Last$32$Name$_ID_$ = 522;
	public static Label item$32$1;
	public static final int item$32$1$_ID_$ = 523;
	public static Label item$32$2;
	public static final int item$32$2$_ID_$ = 524;
	public static Label Matrix2;
	public static final int Matrix2$_ID_$ = 525;
	public static Label test$32$item;
	public static final int test$32$item$_ID_$ = 526;
	public static Label Matrix2$95$1;
	public static final int Matrix2$95$1$_ID_$ = 527;
	public static Label Matrix3;
	public static final int Matrix3$_ID_$ = 528;


	//  MultiPart Symbols:
	public static Label FIELD$__$NAMES;
	public static final int FIELD$__$NAMES$_ID_$ = 236;
	public static Label FIELD$__$TYPES;
	public static final int FIELD$__$TYPES$_ID_$ = 237;
	public static Label FIELD$__$DESC;
	public static final int FIELD$__$DESC$_ID_$ = 238;
	public static Label FIELD$__$DEFAULTS;
	public static final int FIELD$__$DEFAULTS$_ID_$ = 239;
	public static Label MATRIX$__$BASE;
	public static final int MATRIX$__$BASE$_ID_$ = 241;
	public static Label MATRIX$__$STANDARD;
	public static final int MATRIX$__$STANDARD$_ID_$ = 242;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed,
		...
		FIELD$__$NAMES = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 236, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
		...
		FIELD$__$TYPES = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 237, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
		...
		FIELD$__$DESC = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 238, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
		...
		FIELD$__$DEFAULTS = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 239, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
		...
		MATRIX$__$BASE = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 241, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
		...
		MATRIX$__$STANDARD = (have_ParentAppControl) ? multiPartSymbol_Factory.createNew_Label(symbolStrings, 242, creation_StartLevel, creation_Has_StaticVersion, have_Created_New_MultiPartSymbol, newlyCreatedSymbols) :
