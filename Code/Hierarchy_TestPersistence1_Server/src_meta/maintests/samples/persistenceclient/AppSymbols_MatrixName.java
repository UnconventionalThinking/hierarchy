...
public class AppSymbols_MatrixName { 
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		maintests$__$samples$__$persistenceclient$_CC_$Test$__$Matrix = multiLevelSymbol_Factory.createNew_MatrixName(AppSymbols_DescTagName.maintests$__$samples$__$persistenceclient, AppSymbols_DescTagName.Test$__$Matrix,creation_Has_StaticVersion);

		//  `maintests`.`samples`.`persistenceclient`.`otherpackage`::`Test`.`Matrix2`

		maintests$__$samples$__$persistenceclient$__$otherpackage$_CC_$Test$__$Matrix2 = multiLevelSymbol_Factory.createNew_MatrixName(AppSymbols_DescTagName.maintests$__$samples$__$persistenceclient$__$otherpackage, AppSymbols_DescTagName.Test$__$Matrix2,creation_Has_StaticVersion);
