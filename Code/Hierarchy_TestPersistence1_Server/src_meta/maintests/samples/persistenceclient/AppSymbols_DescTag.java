...
public class AppSymbols_DescTag { 
	...
	public static DescriptorTag maintests$__$samples$__$persistenceclient$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED;
	public static DescriptorTag maintests$__$samples$__$persistenceclient$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECTOR;
	public static DescriptorTag maintests$__$samples$__$persistenceclient$_CC_$WEB$__$FORM$_CC_$OPTION;
	public static DescriptorTag net$__$unconventional$__$persistence$_CC_$MATRIXPROG$__$PERSISTENCE$_CC_$MATRIXPROG$__$PERSISTENCE$__$SETTINGS;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  `maintests`.`samples`.`persistenceclient`::`WEB`.`FORM`::`FORM`.`REQUIRED`

		maintests$__$samples$__$persistenceclient$_CC_$WEB$__$FORM$_CC_$FORM$__$REQUIRED = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$__$persistenceclient$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$REQUIRED,creation_Has_StaticVersion);

		//  `maintests`.`samples`.`persistenceclient`::`WEB`.`FORM`::`FORM`.`SELECTOR`

		maintests$__$samples$__$persistenceclient$_CC_$WEB$__$FORM$_CC_$FORM$__$SELECTOR = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$__$persistenceclient$_CC_$WEB$__$FORM, AppSymbols_DescTagName.FORM$__$SELECTOR,creation_Has_StaticVersion);

		//  `maintests`.`samples`.`persistenceclient`::`WEB`.`FORM`::OPTION

		maintests$__$samples$__$persistenceclient$_CC_$WEB$__$FORM$_CC_$OPTION = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.maintests$__$samples$__$persistenceclient$_CC_$WEB$__$FORM, AppSymbols_DescTagName.OPTION,creation_Has_StaticVersion);

		//  `net`.`unconventional`.`persistence`::`MATRIXPROG`.`PERSISTENCE`::`MATRIXPROG`.`PERSISTENCE`.`SETTINGS`

		net$__$unconventional$__$persistence$_CC_$MATRIXPROG$__$PERSISTENCE$_CC_$MATRIXPROG$__$PERSISTENCE$__$SETTINGS = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.net$__$unconventional$__$persistence$_CC_$MATRIXPROG$__$PERSISTENCE, AppSymbols_DescTagName.MATRIXPROG$__$PERSISTENCE$__$SETTINGS,creation_Has_StaticVersion);
