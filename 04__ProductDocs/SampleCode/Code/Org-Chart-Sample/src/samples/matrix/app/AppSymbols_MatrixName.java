...
public class AppSymbols_MatrixName { 
	...
	public static MatrixName com$__$mycompany$__$hr$_CC_$employee;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  `com`.`mycompany`.`hr`::employee

		com$__$mycompany$__$hr$_CC_$employee = multiLevelSymbol_Factory.createNew_MatrixName(AppSymbols_DescTagName.com$__$mycompany$__$hr, AppSymbols_DescTagName.employee,creation_Has_StaticVersion);
