...
public class AppSymbols_SchemaName { 
	...
	public static MatrixName org$__$apache$__$jsp$_CC_$OrgChart;
	public static MatrixName org$__$apache$__$jsp$_CC_$currEmployeeDesc;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  `org`.`apache`.`jsp`::OrgChart

		org$__$apache$__$jsp$_CC_$OrgChart = multiLevelSymbol_Factory.createNew_SchemaName(AppSymbols_DescTagName.org$__$apache$__$jsp, AppSymbols_DescTagName.OrgChart,creation_Has_StaticVersion);

		//  `org`.`apache`.`jsp`::currEmployeeDesc

		org$__$apache$__$jsp$_CC_$currEmployeeDesc = multiLevelSymbol_Factory.createNew_SchemaName(AppSymbols_DescTagName.org$__$apache$__$jsp, AppSymbols_DescTagName.currEmployeeDesc,creation_Has_StaticVersion);
