...
public class OrgChartPrinter__MatrixWorker {
	...
	public static Descriptor accessMatrix_OrgChart__19(ExecutionInfo executeInfo, OrgChartPrinter__Annotations callerObj) {

		//  Static Descriptor Access by Static Label, id1.
		Descriptor Descriptor__38__STATIC__LBL_id1 = null;

		if (DescriptorUtilities.validDescriptors(executeInfo, com.mycompany.hr.OrgChart.matrix)) {
			try{
				Descriptor__38__STATIC__LBL_id1 = com.mycompany.hr.OrgChart.matrix.get_ChildDescriptor(executeInfo, AppSymbols_Label.id1);
			} catch (Exception e) {
		...
		if (executeInfo.get_HadError()) {
			...
			if (accessReturnType_OutParam != null && accessReturnType_OutParam.returnType == AnnotationParameters.AccessReturnType.accessorValue)
				Descriptor__38__STATIC__LBL_id1 = (Descriptor)annotateRetVal;
		...
		return Descriptor__38__STATIC__LBL_id1;
	...
	//  Continued Access
	public static Descriptor accessMatrixForFieldAssign___20(ExecutionInfo executeInfo, Descriptor descriptor, OrgChartPrinter__Annotations callerObj) {
	...
	//  Continued Access
	public static MatrixSet<Descriptor> accessMatrix___21(ExecutionInfo executeInfo, Descriptor descriptor, OrgChartPrinter__Annotations callerObj, DescriptorTagName accessParam_0__value1) {


		//  Multi Access with access expression: AppSymbols_DescTagName.EMPLOYEE.
		MatrixSet<Descriptor> DescriptorSet__40__MULTI_ACCESS = null;
		if (DescriptorUtilities.validDescriptors(executeInfo, descriptor)) {
			try{
				DescriptorSet__40__MULTI_ACCESS = descriptor.get_ChildDescriptors(executeInfo,accessParam_0__value1);
			} catch (Exception e) {
				executeInfo.setErrorException(e);
			}
		...
		if (executeInfo.get_HadError()) {
			...
			if (accessReturnType_OutParam != null && accessReturnType_OutParam.returnType == AnnotationParameters.AccessReturnType.accessorValue)
				DescriptorSet__40__MULTI_ACCESS = (MatrixSet<Descriptor>)annotateRetVal;
			else // accessReturnType_OutParam.returnType == AnnotationParameters.AccessReturnType.accessValue)
		...
		return DescriptorSet__40__MULTI_ACCESS;
	...
	//  Continued Access
	public static Descriptor accessMatrixForFieldAssign___22(ExecutionInfo executeInfo, Descriptor descriptor, OrgChartPrinter__Annotations callerObj) {
	...
	public static Descriptor accessMatrix_OrgChart__23(ExecutionInfo executeInfo, OrgChartPrinter__Annotations callerObj) {

		//  Static Descriptor Access by Static Label, id1.
		Descriptor Descriptor__42__STATIC__LBL_id1 = null;

		if (DescriptorUtilities.validDescriptors(executeInfo, com.mycompany.hr.OrgChart.matrix)) {
			try{
				Descriptor__42__STATIC__LBL_id1 = com.mycompany.hr.OrgChart.matrix.get_ChildDescriptor(executeInfo, AppSymbols_Label.id1);
			} catch (Exception e) {
				executeInfo.setErrorException(e);
			}
		...
		if (executeInfo.get_HadError()) {
			...
			if (accessReturnType_OutParam != null && accessReturnType_OutParam.returnType == AnnotationParameters.AccessReturnType.accessorValue)
				Descriptor__42__STATIC__LBL_id1 = (Descriptor)annotateRetVal;
			else // accessReturnType_OutParam.returnType == AnnotationParameters.AccessReturnType.accessValue)
				return (Descriptor)annotateRetVal;
		}
		...
		return Descriptor__42__STATIC__LBL_id1;
	...
	//  Continued Access
	public static int accessMatrix___24(ExecutionInfo executeInfo, Descriptor descriptor, OrgChartPrinter__Annotations callerObj) {
	...
	//  Continued Access
	public static String accessMatrix___25(ExecutionInfo executeInfo, Descriptor descriptor, OrgChartPrinter__Annotations callerObj) {
	...
	//  Continued Access
	public static String accessMatrix___26(ExecutionInfo executeInfo, Descriptor descriptor, OrgChartPrinter__Annotations callerObj) {
