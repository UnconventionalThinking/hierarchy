...
public class AppSymbols_DescTag { 
	...
	public static DescriptorTag com$__$mycompany$__$hr$_CC_$OrgChart$__$Schema$_CC_$EMPLOYEE;
	...
	static void initialize(SymbolControl symbol_Control, boolean have_ParentAppControl) throws Exception_InvalidArgumentPassed_Null, Exception_InvalidArgumentPassed {
		...
		//  `com`.`mycompany`.`hr`::`OrgChart`.`Schema`::EMPLOYEE

		com$__$mycompany$__$hr$_CC_$OrgChart$__$Schema$_CC_$EMPLOYEE = multiLevelSymbol_Factory.createNew_DescriptorTag(AppSymbols_SchemaName.com$__$mycompany$__$hr$_CC_$OrgChart$__$Schema, AppSymbols_DescTagName.EMPLOYEE,creation_Has_StaticVersion);
